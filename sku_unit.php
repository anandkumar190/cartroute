        ...
        <section class="col-lg-12">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-left">
              <li class="active"><a href="#today-activity" data-toggle="tab"> Sku unit</a></li>
              <li><a href="#tear-tree-view" data-toggle="tab">Add Sku</a></li>
						...
						<div class="col-sm-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Sku Unit</h6>
									</div>
   ...
   $('#userstable tbody').on( 'click','tr td', function (){
	...
	var id=$(this).children('input:hidden').val();
		...
		{	
		  	  	//alert(id);
		         $.ajax({
		         url:"api/sku_unitapi.php?statestatus&status=0&id="+id,
		         type:"POST",
		         contentType:"application/json; charset=utf-8",
			     success: function(data){
			         		if(data=="success")
		  ...
		  $.ajax({
		         url:"api/sku_unitapi.php?statestatus&status=1&id="+id,
		         type:"POST",
		         contentType:"application/json; charset=utf-8",
			     success: function(data){
			         		if(data=="success")
...
function sendData(){
       ...
       //  });
        ...
        $.ajax({
            url: 'api/sku_unitapi.php?insert',
            type: 'post',
            data: fd,
            success: function(response){
				if(response=="name")
				{
				   ...
				   return;
	                ...
	                if(response =="success"){
                    alert(" Sku unit  Created Successfully...");
